...
?>
	...
	<div id="rtoc-screen-wrapper">
		<div class="rtoc_ad_contents">
			<ul>
				<li>
					<a href="https://jin-theme.com/" class="rtoc_ad_link" target="_blank">
						<p class="rtoc_ad_ttl">Our Products</p>
						<img src="<?php echo (plugins_url('../img/ad_jin.png', __FILE__)) ?>" alt="WordPressテーマ「JIN」" class="rtoc_ad_img">
					</a>
				</li>
				<?php

...
function rtoc_get_index()
{
	...
	if (!is_plugin_active('rich-table-of-content-addon/rtoc-addon.php')) {
		...
		$content_inside = '<div id="rtoc-mokuji-wrapper" class="rtoc-mokuji-content ' . $rtoc_frame_design . ' ' . $rtoc_h2_timeline . ' ' . $rtoc_h3_timeline . ' ' . $rtoc_color . ' ' . $rtoc_animation . ' ' . $rtoc_initial_display . ' ' . $rtoc_font . '" data-id="' . $post_id . '" data-theme="' . $theme_name . '">

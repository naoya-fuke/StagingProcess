...
> Note: For those users who were/are affected by the CoBlocks 3.0.0 release, please review our [WordPress.org support forum post](https://wordpress.org/support/topic/coblocks-v3-0-0-error-and-recovery/), and create a new thread if you still need support.
